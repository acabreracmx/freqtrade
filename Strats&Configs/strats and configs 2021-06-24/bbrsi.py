...
class BBRSI(IStrategy):
    ...
    buy_trigger =CategoricalParameter(['bb_lower1',
                                        'bb_lower2',
                                        'bb_lower3'], default="bb_lower2", space="buy")

    sell_rsi = IntParameter(50, 100, default=88, space="sell")
    sell_rsi_enabled = CategoricalParameter([True, False], default=True, space="sell")
    sell_trigger= CategoricalParameter([#'sell-bb_lower2',
                                        'sell-bb_lower1',
                                        'sell-bb_middle1',
                                        'sell-bb_upper1'], default='sell-bb_upper1', space='sell')
    stoploss = RealParameter(-0.02, -0.5, default=-0.4275704128061333, space="stoploss")
    """
